...
class LauncherActivity: FragmentActivity() {
    ...
    class LauncherFragment: OnboardingSupportFragment() {
        ...
        override fun getPageTitle(pageIndex: Int): CharSequence {
            return getString(com.zitherharp.music.R.string.video_app_name)
        }
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
            logoResourceId = com.zitherharp.music.R.mipmap.ic_video_launcher
        }
        ...
        override fun onCreateContentView(inflater: LayoutInflater?, container: ViewGroup?): View {
            return ImageView(context).apply {
                ...
                setImageResource(com.zitherharp.music.R.mipmap.ic_video_launcher)
            }
        }
